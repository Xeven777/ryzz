      ...
      <div className="p-0 shadow border-b-2 justify-center items-center sticky top-0 z-10 min-w-full bg-inherit">
        <div className="max-w-6xl m-auto items-center flex flex-wrap justify-between px-4 lg:px-2 py-2">
          <div>
            ...
            >
              <h1 className="text-4xl p-2 font-bold __className_938c5f bg-clip-text text-transparent bg-gradient-to-tl from-violet-600 via-purple-700 to-fuchsia-400 logo">
                Ryzz
              </h1>
            </Link>
          </div>
